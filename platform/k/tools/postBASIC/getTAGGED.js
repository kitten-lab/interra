...
$.when(
  $.getJSON('../../../d/_charlieCATALOG/tag_catalogs/a-node.catalog.json'),
  $.getJSON('../../../d/_charlieCATALOG/tag_catalogs/b-node.catalog.json'),
  $.getJSON('../../../d/_charlieCATALOG/tag_catalogs/c-node.catalog.json')
