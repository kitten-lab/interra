<div style="position:fixed; width: 60vh;">
<h1>LOG SELECTOR

    <select 
        id="entrySelector" 
        style="width: 20vh; height: 30px; font-family: 'VT323'; background-color: black; border: 1px solid var(--my-fav-color); color: var(--my-fav-color);"
    >
        <option 
            style="width: 20vh; height: 30px; font-family: 'VT323'; background-color: black; border: 1px solid var(--my-fav-color); color: var(--my-fav-color);"
            >
